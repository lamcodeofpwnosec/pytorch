...
class ExportGraphSignature:
    ...
    def user_inputs(self) -> Collection[Union[int, float, bool, None, str]]:
        ...
        for s in self.input_specs:
            ...
            if isinstance(s.arg, (TensorArgument, SymIntArgument, SymBoolArgument, CustomObjArgument)):
    ...
    def replace_all_uses(self, old: str, new: str):
        ...
        arg_types = (TensorArgument, SymIntArgument, SymBoolArgument, CustomObjArgument, TokenArgument)
...
def _make_argument_spec(node, token_names) -> ArgumentSpec:
    from torch import ScriptObject, SymInt, SymBool
    from torch._library.fake_class_registry import FakeScriptObject
